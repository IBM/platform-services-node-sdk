...
class ContextBasedRestrictionsV1 extends BaseService {
   ...
   * List network zones.
   *
   * A list of network zones in the specified account is returned.
   *
   * @param {Object} params - The parameters to send to the service.
   ...
   *
   * This operation updates the network zone for the specified ID.
   *
   * @param {Object} params - The parameters to send to the service.
   * @param {string} params.zoneId - The ID of a zone.
   ...
   *
   * This operation deletes the network zone for the specified home ID.
   *
   * @param {Object} params - The parameters to send to the service.
   * @param {string} params.zoneId - The ID of a zone.
   * @param {string} [params.transactionId] - The UUID that is used to correlate and track transactions. If you omit
