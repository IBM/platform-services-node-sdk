...
describe('IamIdentityV1_integration', () => {
  ...
  test('createServiceIdGroup()', (done) => {
    ...
    iamIdentityService
      ...
      .then((res) => {
        ...
        const { result } = res;
        expect(result).not.toBeNull();
        // console.log('createServiceIdGroup() result: ', result);
        expect(result.id).not.toBeNull();
  ...
  test('getServiceIdGroup()', (done) => {
    ...
    iamIdentityService
      ...
      .then((res) => {
        ...
        const { result } = res;
        // console.log('getServiceIdGroup() result: ', result);
        expect(result).not.toBeNull();
  ...
  test('listServiceIdGroup()', (done) => {
    ...
    iamIdentityService
      ...
      .then((res) => {
        ...
        const { result } = res;
        expect(result).not.toBeNull();
        // console.log('listServiceIdGroup() result: ', result);
  ...
  test('updateServiceIdGroup()', (done) => {
    ...
    iamIdentityService
      ...
      .then((res) => {
        ...
        const { result } = res;
        expect(result).not.toBeNull();
        // console.log('updateServiceIdGroup() result: ', result);
  ...
  test('deleteServiceIdGroup()', (done) => {
    ...
    iamIdentityService
      ...
      .then((res) => {
        expect(res).not.toBeNull();
        // console.log('deleteServiceIdGroup() response: ', res);
        expect(res.status).toEqual(204);
