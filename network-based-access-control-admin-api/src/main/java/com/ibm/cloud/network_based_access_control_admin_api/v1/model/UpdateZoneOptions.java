...
public class UpdateZoneOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(UpdateZoneOptions updateZoneOptions) {
      this.zoneId = updateZoneOptions.zoneId;
      this.ifMatch = updateZoneOptions.ifMatch;
      this.name = updateZoneOptions.name;
      this.accountId = updateZoneOptions.accountId;
      this.description = updateZoneOptions.description;
      this.addresses = updateZoneOptions.addresses;
      this.excluded = updateZoneOptions.excluded;
      this.transactionId = updateZoneOptions.transactionId;
    }
