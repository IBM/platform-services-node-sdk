...
public class ListPoliciesOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(ListPoliciesOptions listPoliciesOptions) {
      ...
      this.transactionId = listPoliciesOptions.transactionId;
      this.region = listPoliciesOptions.region;
      this.resource = listPoliciesOptions.resource;
      this.resourceType = listPoliciesOptions.resourceType;
      this.serviceInstance = listPoliciesOptions.serviceInstance;
      this.serviceName = listPoliciesOptions.serviceName;
      this.serviceType = listPoliciesOptions.serviceType;
      this.zoneId = listPoliciesOptions.zoneId;
