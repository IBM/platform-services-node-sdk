...
/**
 * Unit test class for the PolicyPage model.
 */
public class PolicyPageTest {
  ...
  @Test
  public void testPolicyPage() throws Throwable {
    PolicyPage policyPageModel = new PolicyPage();
    assertNull(policyPageModel.getCount());
    assertNull(policyPageModel.getPolicies());
  }
}