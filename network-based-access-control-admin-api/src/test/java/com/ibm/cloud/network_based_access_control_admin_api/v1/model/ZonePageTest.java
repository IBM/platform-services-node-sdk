...
/**
 * Unit test class for the ZonePage model.
 */
public class ZonePageTest {
  ...
  @Test
  public void testZonePage() throws Throwable {
    ZonePage zonePageModel = new ZonePage();
    assertNull(zonePageModel.getCount());
    assertNull(zonePageModel.getZones());
  }
}