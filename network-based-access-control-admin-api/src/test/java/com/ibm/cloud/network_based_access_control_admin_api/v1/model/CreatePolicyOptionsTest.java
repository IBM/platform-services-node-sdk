...
public class CreatePolicyOptionsTest {
  ...
  public void testCreatePolicyOptions() throws Throwable {
    ...
    assertEquals(createPolicyOptionsModel.environments(), new java.util.ArrayList<Environment>(java.util.Arrays.asList(environmentModel)));
    assertEquals(createPolicyOptionsModel.resources(), new java.util.ArrayList<Resource>(java.util.Arrays.asList(resourceModel)));
    assertEquals(createPolicyOptionsModel.transactionId(), "testString");
  }
}