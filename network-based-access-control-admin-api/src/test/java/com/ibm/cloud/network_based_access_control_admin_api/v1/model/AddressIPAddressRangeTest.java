...
/**
 * Unit test class for the AddressIPAddressRange model.
 */
public class AddressIPAddressRangeTest {
  ...
  public void testAddressIPAddressRangeError() throws Throwable {
    new AddressIPAddressRange.Builder().build();
  }
