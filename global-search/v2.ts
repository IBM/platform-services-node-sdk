...
class GlobalSearchV2 extends BaseService {
  ...
  public search(
    ...
    const _validParams = ['query', 'fields', 'searchCursor', 'xRequestId', 'xCorrelationId', 'accountId', 'limit', 'timeout', 'sort', 'isDeleted', 'isReclaimed', 'isPublic', 'impersonateUser', 'canTag', 'isProjectResource', 'headers'];
